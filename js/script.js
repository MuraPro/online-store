...
/*! nouislider - 14.6.0 - 6/27/2020 */ ! function(t) {
...
let blockBoxs = document.querySelectorAll('.checkbox__text')
// let checkBoxs = document.querySelectorAll('.checkbox__input')
// let spanBtns = document.querySelectorAll('.checkbox__text')



// span

for (let key in blockBoxs) {
    if (blockBoxs.hasOwnProperty(key)) {
        for(let i = 0; i < blockBoxs.length; i++) {
            const blockBox = blockBoxs[i]
            blockBox.addEventListener('click', function(e) {
                blockBox.classList.toggle('_active')
            })
...
for (let index = 0; index < checkboxCategories.length; index++) {
  ...
  checkboxCategory.addEventListener("click", function (e) {
    ...
    if (checkboxActiveCategories.length > 0) {
      ...
      // отправляем обьекты в спан над меню с выбором категории товаров
